...
package org.unixminecraft.bungeeipc.bungeebukkit.command;
...
import org.unixminecraft.bungeeipc.bungeebukkit.BungeeIPCPlugin;
import org.unixminecraft.bungeeipc.bungeebukkit.api.IPCMessage;

public final class IPCCommand implements TabExecutor {
	
	private final BungeeIPCPlugin ipcPlugin;
	
	public IPCCommand(final BungeeIPCPlugin ipcPlugin) {
